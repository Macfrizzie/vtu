...
import { LayoutDashboard, Users, Zap, History, Cog, Plug, DollarSign } from 'lucide-react';
...
const protectedAdminRoutes = ['/admin/dashboard', '/admin/users', '/admin/services', '/admin/transactions', '/admin/api-providers', '/admin/api-connector', '/admin/pricing'];
