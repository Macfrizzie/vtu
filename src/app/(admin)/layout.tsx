...
import { LayoutDashboard, Users, Zap, History, Cog, Plug, Wand2 } from 'lucide-react';
...
const navItems: NavItem[] = [
    ...
    { href: '/admin/api-connector', title: 'AI Connector', icon: <Wand2 className="h-4 w-4" /> },
];

const protectedAdminRoutes = ['/admin/dashboard', '/admin/users', '/admin/services', '/admin/transactions', '/admin/api-connector', '/admin/api-providers'];
