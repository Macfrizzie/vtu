  ...
  const handleFormOpen = (provider: ApiProvider | null) => {
    ...
    if (provider) {
        form.reset({
            ...
            paylony_secretKey: provider.paylony_secretKey || '',
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Paylony">Paylony</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
                ...
                {authType === 'VPay' ? (
                  <>
                    ...
                    <>
                    <FormField control={form.control} name="paylony_secretKey" render={({ field }) => (
                        <FormItem><FormLabel>Paylony Secret Key</FormLabel><FormControl><Input type="password" placeholder="Enter Paylony Secret Key" {...field} /></FormControl><FormMessage /></FormItem>
                    )} />
                    </>
                ) : authType !== 'None' ? (
                    <>
